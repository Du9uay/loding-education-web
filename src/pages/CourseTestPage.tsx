...
const CourseTestPage: React.FC = () => {
  ...
  const sequenceQuestions = useMemo(() => [
    {
      id: 'warehouse_development_stages',
      question: '请将智慧仓储发展阶段按正确顺序排列：',
      items: [
        { id: 'intelligent_stage', text: '智能化阶段（4.0）' },
        { id: 'mechanical_stage', text: '机械化阶段（1.0）' },
        { id: 'information_stage', text: '信息化阶段（3.0）' },
        { id: 'automation_stage', text: '自动化阶段（2.0）' }
      ],
      correctOrder: ['mechanical_stage', 'automation_stage', 'information_stage', 'intelligent_stage']
    },
    {
      id: 'warehouse_core_goals',
      question: '请将智慧仓储核心目标按重要性排列：',
      items: [
        { id: 'improve_efficiency', text: '提高效率' },
        { id: 'reduce_costs', text: '降低成本' },
        { id: 'enhance_accuracy', text: '提升库存精度' }
      ],
      correctOrder: ['improve_efficiency', 'enhance_accuracy', 'reduce_costs']
    }
  ], []);
  ...
  const matchingQuestions = useMemo(() => [
    {
      ...
      leftItems: [
        { id: 'l1', text: '数字孪生技术' },
        { id: 'l2', text: '仓库控制系统(WCS)' },
        { id: 'l3', text: '5G AGV群控技术' }
      ],
      rightItems: [
        { id: 'r1', text: '模拟仓储运作预判设备故障' },
        { id: 'r2', text: '管理堆垛机等设备队列避免碰撞' },
        { id: 'r3', text: '实现百台级AGV协同搬运' }
      ],
      correctMatches: {
        'l1': 'r1', // 数字孪生技术 - 模拟仓储运作预判设备故障
        'l2': 'r2', // 仓库控制系统(WCS) - 管理堆垛机等设备队列避免碰撞
        'l3': 'r3'  // 5G AGV群控技术 - 实现百台级AGV协同搬运
      }
    }
  ], []);
  ...
  const multipleChoice = [
    {
      id: 'q1',
      question: '关于智慧仓储发展阶段的特征，以下描述正确的是？',
      options: [
    ...
    {
      id: 'q3',
      question: '自动化立体仓库的空间利用率计算公式是？',
      options: [
        'A. 实际存储货物体积 ÷ 货架总容积 × 100%',
        'B. 实际存储货物体积 ÷ 仓库总容积 × 100%',
        'C. 货架总容积 ÷ 仓库总容积 × 100%',
        'D. 实际存储货物数量 ÷ 最大存储数量 × 100%'
      ],
      correct: 'B'
    },
    {
      id: 'q4',
      question: '在智慧仓储系统中，WCS的主要功能是？',
      options: [
        'A. 库存管理和订单调度',
        'B. 企业资源规划整合',
        'C. 设备控制和协同管理',
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <Award className="w-10 h-10 text-[color:var(--accent-logistics-500)]" />
          </motion.div>
          <motion.h1 
          ...
          >
            <RefreshCw className="w-5 h-5 text-[color:var(--accent-logistics-500)] mr-2" />
                  ...
                  <div key={question.id} className="glass-effect rounded-2xl p-8">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h4 className="text-[color:var(--accent-logistics-500)] font-medium mb-4">智慧仓储技术</h4>
              ...
              <div className="text-center">
                ...
                <div className={`p-6 rounded-lg mb-6 ${
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    {score.score >= 80 ? 
                      '恭喜您！您已经很好地掌握了智慧仓储系统的基础知识，可以进入下一阶段的学习。' :
                      score.score >= 60 ?
                      '您对智慧仓储基础知识有一定掌握，建议复习薄弱环节，加强实践练习。' :
                      '建议您重新学习相关章节，特别关注智慧仓储的发展阶段、系统组成和核心技术。'
                    }
                  </p>
              </div>
              </div>
